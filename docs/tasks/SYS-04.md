# SYS-04 — Narrative continuity and meaningful duration

**Status:** Authored connected draft; blind pacing review open. **Dependencies:** SYS-03; all room scripts.

## Objective

Every factual claim has an obtainable source. All endings agree with the chosen route. Human playtest observations support the advertised duration and emotional arc.
...
Read a complete route without looking at solutions. Trace Elian’s physical/remote location after both Chapel choices and both return choices. Verify the thirteenth vessel explanation, alias consent, original-versus-photographed evidence, and the relay dependency. Measure exploration, reading and puzzles separately with unfamiliar players. Add specific discoveries and conversations where comprehension or pacing needs them; never add arbitrary waits to claim 180 minutes.
