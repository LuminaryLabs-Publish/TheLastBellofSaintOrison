# L06 — Complete production review of Bell Tower Base

**Status:** First-pass room implemented; production quality and browser/hardware acceptance remain open. **Owner:** game room production. **Dependencies:** SYS-01, SYS-02, SYS-03; preceding room Apothecary.

## Start with these inputs

1. [Location design](../../content/locations/bell-tower-base/location-design.md).
2. [Exact puzzle and hint contract](../../content/locations/bell-tower-base/investigations-and-puzzles.md).
3. [Actual scene writing](../../content/locations/bell-tower-base/scenes-and-dialogue.md).
4. [Pressure and branch effects](../../content/locations/bell-tower-base/pressure-and-outcomes.md).
5. [Asset inventory](../../content/locations/bell-tower-base/assets.md).
6. [Architecture](../architecture/nexus.md) and [review protocol](../validation/protocol.md).

## Desired player result

Learn the bell cycle and choose how to interrupt it. The player understands enough to choose among “Leave the relay intact”, “Break the shaft · disables Witness transmission” and reaches School Hall with the recorded state intact.
...
2. Play the current room using ordinary visible controls. Required knowledge: governor-order, silence-method. Record where the goal or clue is unclear.
3. Verify the exact solution Open bypass → Release tension → Engage brake. Try a plausible incorrect input; inspect the stated feedback and recover without reloading.
4. Review each local alternative, including preserve, break. Trace outgoing state into the next room; do not substitute branch count for cross-room proof.
