# L02 — Complete production review of Visitor Centre

**Status:** First-pass room implemented; production quality and browser/hardware acceptance remain open. **Owner:** game room production. **Dependencies:** SYS-01, SYS-02, SYS-03; preceding room Town Gate.

## Start with these inputs

1. [Location design](../../content/locations/visitor-centre/location-design.md).
2. [Exact puzzle and hint contract](../../content/locations/visitor-centre/investigations-and-puzzles.md).
3. [Actual scene writing](../../content/locations/visitor-centre/scenes-and-dialogue.md).
4. [Pressure and branch effects](../../content/locations/visitor-centre/pressure-and-outcomes.md).
5. [Asset inventory](../../content/locations/visitor-centre/assets.md).
6. [Architecture](../architecture/nexus.md) and [review protocol](../validation/protocol.md).

## Desired player result

Restore the map and establish Elian’s next stop. The player understands enough to choose among “Follow Elian’s café entry”, “Follow the evacuation staff route” and reaches Closed Café with the recorded state intact.
...
2. Play the current room using ordinary visible controls. Required knowledge: map-circuit, cafe-lead. Record where the goal or clue is unclear.
3. Verify the exact solution Disconnect red → Connect blue → Connect amber. Try a plausible incorrect input; inspect the stated feedback and recover without reloading.
4. Review each local alternative, including front, service. Trace outgoing state into the next room; do not substitute branch count for cross-room proof.
