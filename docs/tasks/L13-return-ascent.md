# L13 — Complete production review of Return Ascent

**Status:** First-pass room implemented; production quality and browser/hardware acceptance remain open. **Owner:** game room production. **Dependencies:** SYS-01, SYS-02, SYS-03; preceding room Well Chamber.

## Start with these inputs

1. [Location design](../../content/locations/return-ascent/location-design.md).
2. [Exact puzzle and hint contract](../../content/locations/return-ascent/investigations-and-puzzles.md).
3. [Actual scene writing](../../content/locations/return-ascent/scenes-and-dialogue.md).
4. [Pressure and branch effects](../../content/locations/return-ascent/pressure-and-outcomes.md).
5. [Asset inventory](../../content/locations/return-ascent/assets.md).
6. [Architecture](../architecture/nexus.md) and [review protocol](../validation/protocol.md).

## Desired player result

Use the verified return route and make it back above ground. The player understands enough to choose among “Continue to the square”, “Hold the line until Elian confirms her route” and reaches Town Square with the recorded state intact.
...
2. Play the current room using ordinary visible controls. Required knowledge: return-order, elian-return. Record where the goal or clue is unclear.
3. Verify the exact solution Empty circle → Closed eye → Mouth → Open eye. Try a plausible incorrect input; inspect the stated feedback and recover without reloading.
4. Review each local alternative, including leave, help. Trace outgoing state into the next room; do not substitute branch count for cross-room proof.
