# L11 — Complete production review of Maintenance Tunnels

**Status:** First-pass room implemented; production quality and browser/hardware acceptance remain open. **Owner:** game room production. **Dependencies:** SYS-01, SYS-02, SYS-03; preceding room Parish House.

## Start with these inputs

1. [Location design](../../content/locations/maintenance-tunnels/location-design.md).
2. [Exact puzzle and hint contract](../../content/locations/maintenance-tunnels/investigations-and-puzzles.md).
3. [Actual scene writing](../../content/locations/maintenance-tunnels/scenes-and-dialogue.md).
4. [Pressure and branch effects](../../content/locations/maintenance-tunnels/pressure-and-outcomes.md).
5. [Asset inventory](../../content/locations/maintenance-tunnels/assets.md).
6. [Architecture](../architecture/nexus.md) and [review protocol](../validation/protocol.md).

## Desired player result

Follow the utility markings and preserve a return route. The player understands enough to choose among “Continue along the verified pipes”, “Chalk the return direction before proceeding” and reaches Well Chamber with the recorded state intact.
...
2. Play the current room using ordinary visible controls. Required knowledge: tunnel-order, container-proof. Record where the goal or clue is unclear.
3. Verify the exact solution Open eye → Mouth → Closed eye → Empty circle. Try a plausible incorrect input; inspect the stated feedback and recover without reloading.
4. Review each local alternative, including direct, mark. Trace outgoing state into the next room; do not substitute branch count for cross-room proof.
