# Chapel Nave — validation

Status: implementation and regression review
Owner: unassigned. Package: `src/kits/locations/chapel-nave`.

Outcome: Verify Elian’s identity and decide whether to release her. Improve legal routes, failed actions, save restoration and disposal while preserving reachable exit `parish-house`.
