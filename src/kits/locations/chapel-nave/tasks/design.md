...
Outcome: Verify Elian’s identity and decide whether to release her. Improve layout, visible goal and fair warning signals while preserving reachable exit `parish-house`.
