# Flooded Archive — validation

Status: implementation and regression review
Owner: unassigned. Package: `src/kits/locations/flooded-archive`.

Outcome: Recover the shutoff record and its carbon original. Improve legal routes, failed actions, save restoration and disposal while preserving reachable exit `chapel-nave`.
