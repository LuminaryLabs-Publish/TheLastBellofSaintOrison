# Flooded Archive — design

Status: production review open
Owner: unassigned. Package: `src/kits/locations/flooded-archive`.

Outcome: Recover the shutoff record and its carbon original. Improve layout, visible goal and fair warning signals while preserving reachable exit `chapel-nave`.
