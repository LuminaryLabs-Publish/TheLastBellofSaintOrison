# Flooded Archive — implementation

Status: implementation and regression review
Owner: unassigned. Package: `src/kits/locations/flooded-archive`.

Outcome: Recover the shutoff record and its carbon original. Improve public operations, dependency bindings and outgoing state while preserving reachable exit `chapel-nave`.
