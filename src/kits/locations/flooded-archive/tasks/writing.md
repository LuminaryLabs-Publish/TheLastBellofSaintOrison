# Flooded Archive — writing

Status: production review open
Owner: unassigned. Package: `src/kits/locations/flooded-archive`.

Outcome: Recover the shutoff record and its carbon original. Improve observations, arrival, dialogue and choice consequences while preserving reachable exit `chapel-nave`.
