# Exit Road — validation

Status: implementation and regression review
Owner: unassigned. Package: `src/kits/locations/exit-road`.

Outcome: Acknowledge the consequence and decide what you carry home. Improve legal routes, failed actions, save restoration and disposal while preserving reachable exit `ending`.
