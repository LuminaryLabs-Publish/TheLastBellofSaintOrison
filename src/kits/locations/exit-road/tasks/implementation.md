# Exit Road — implementation

Status: implementation and regression review
Owner: unassigned. Package: `src/kits/locations/exit-road`.

Outcome: Acknowledge the consequence and decide what you carry home. Improve public operations, dependency bindings and outgoing state while preserving reachable exit `ending`.
