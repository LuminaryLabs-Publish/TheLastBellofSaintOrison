...
Outcome: Recover the relay contract and the descent equipment. Improve layout, visible goal and fair warning signals while preserving reachable exit `maintenance-tunnels`.
