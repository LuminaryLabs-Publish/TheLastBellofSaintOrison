# Parish House — validation

Status: implementation and regression review
Owner: unassigned. Package: `src/kits/locations/parish-house`.

Outcome: Recover the relay contract and the descent equipment. Improve legal routes, failed actions, save restoration and disposal while preserving reachable exit `maintenance-tunnels`.
