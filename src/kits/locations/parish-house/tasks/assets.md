...
Outcome: Recover the relay contract and the descent equipment. Improve scene assets, palette, selection and provenance while preserving reachable exit `maintenance-tunnels`.
