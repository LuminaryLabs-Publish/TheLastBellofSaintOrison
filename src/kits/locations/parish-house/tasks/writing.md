# Parish House — writing

Status: production review open
Owner: unassigned. Package: `src/kits/locations/parish-house`.

Outcome: Recover the relay contract and the descent equipment. Improve observations, arrival, dialogue and choice consequences while preserving reachable exit `maintenance-tunnels`.
