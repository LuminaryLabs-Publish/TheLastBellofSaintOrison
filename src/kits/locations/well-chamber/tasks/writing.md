# Well Chamber — writing

Status: production review open
Owner: unassigned. Package: `src/kits/locations/well-chamber`.

Outcome: Recover the Bell Core and choose a fully explained intervention. Improve observations, arrival, dialogue and choice consequences while preserving reachable exit `return-ascent`.
