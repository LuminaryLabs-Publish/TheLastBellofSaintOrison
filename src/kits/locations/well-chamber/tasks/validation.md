# Well Chamber — validation

Status: implementation and regression review
Owner: unassigned. Package: `src/kits/locations/well-chamber`.

Outcome: Recover the Bell Core and choose a fully explained intervention. Improve legal routes, failed actions, save restoration and disposal while preserving reachable exit `return-ascent`.
