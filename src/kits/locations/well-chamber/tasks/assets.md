...
Outcome: Recover the Bell Core and choose a fully explained intervention. Improve scene assets, palette, selection and provenance while preserving reachable exit `return-ascent`.
