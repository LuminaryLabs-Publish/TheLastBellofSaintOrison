...
Outcome: Recover the Bell Core and choose a fully explained intervention. Improve layout, visible goal and fair warning signals while preserving reachable exit `return-ascent`.
