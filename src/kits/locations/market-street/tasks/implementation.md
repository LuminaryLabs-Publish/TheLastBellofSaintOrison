# Market Street — implementation

Status: implementation and regression review
Owner: unassigned. Package: `src/kits/locations/market-street`.

Outcome: Secure the shutter and collect a service lantern. Improve public operations, dependency bindings and outgoing state while preserving reachable exit `apothecary`.
