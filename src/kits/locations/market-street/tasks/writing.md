# Market Street — writing

Status: production review open
Owner: unassigned. Package: `src/kits/locations/market-street`.

Outcome: Secure the shutter and collect a service lantern. Improve observations, arrival, dialogue and choice consequences while preserving reachable exit `apothecary`.
