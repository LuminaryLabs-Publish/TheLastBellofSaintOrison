...
Outcome: Secure the shutter and collect a service lantern. Improve layout, visible goal and fair warning signals while preserving reachable exit `apothecary`.
