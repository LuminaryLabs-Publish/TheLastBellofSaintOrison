# Market Street — validation

Status: implementation and regression review
Owner: unassigned. Package: `src/kits/locations/market-street`.

Outcome: Secure the shutter and collect a service lantern. Improve legal routes, failed actions, save restoration and disposal while preserving reachable exit `apothecary`.
