# Maintenance Tunnels — assets

Status: production review open
Owner: unassigned. Package: `src/kits/locations/maintenance-tunnels`.

Outcome: Follow the utility markings and preserve a return route. Improve scene assets, palette, selection and provenance while preserving reachable exit `well-chamber`.
