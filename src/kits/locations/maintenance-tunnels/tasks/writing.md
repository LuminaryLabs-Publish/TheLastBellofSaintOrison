# Maintenance Tunnels — writing

Status: production review open
Owner: unassigned. Package: `src/kits/locations/maintenance-tunnels`.

Outcome: Follow the utility markings and preserve a return route. Improve observations, arrival, dialogue and choice consequences while preserving reachable exit `well-chamber`.
