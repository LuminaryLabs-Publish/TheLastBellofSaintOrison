# Town Gate — validation

Status: implementation and regression review
Owner: unassigned. Package: `src/kits/locations/town-gate`.

Outcome: Read the crossing notice, then open a safe route into town. Improve legal routes, failed actions, save restoration and disposal while preserving reachable exit `visitor-centre`.
