...
Outcome: Read the crossing notice, then open a safe route into town. Improve layout, visible goal and fair warning signals while preserving reachable exit `visitor-centre`.
