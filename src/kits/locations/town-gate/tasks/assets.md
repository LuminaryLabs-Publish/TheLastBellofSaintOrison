...
Outcome: Read the crossing notice, then open a safe route into town. Improve scene assets, palette, selection and provenance while preserving reachable exit `visitor-centre`.
