...
Outcome: Read the crossing notice, then open a safe route into town. Improve observations, arrival, dialogue and choice consequences while preserving reachable exit `visitor-centre`.
