# Visitor Centre — assets

Status: production review open
Owner: unassigned. Package: `src/kits/locations/visitor-centre`.

Outcome: Restore the map and establish Elian’s next stop. Improve scene assets, palette, selection and provenance while preserving reachable exit `closed-cafe`.
