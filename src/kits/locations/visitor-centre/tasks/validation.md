# Visitor Centre — validation

Status: implementation and regression review
Owner: unassigned. Package: `src/kits/locations/visitor-centre`.

Outcome: Restore the map and establish Elian’s next stop. Improve legal routes, failed actions, save restoration and disposal while preserving reachable exit `closed-cafe`.
