# Visitor Centre — writing

Status: production review open
Owner: unassigned. Package: `src/kits/locations/visitor-centre`.

Outcome: Restore the map and establish Elian’s next stop. Improve observations, arrival, dialogue and choice consequences while preserving reachable exit `closed-cafe`.
