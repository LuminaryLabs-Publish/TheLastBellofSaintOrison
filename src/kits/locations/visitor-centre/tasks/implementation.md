# Visitor Centre — implementation

Status: implementation and regression review
Owner: unassigned. Package: `src/kits/locations/visitor-centre`.

Outcome: Restore the map and establish Elian’s next stop. Improve public operations, dependency bindings and outgoing state while preserving reachable exit `closed-cafe`.
