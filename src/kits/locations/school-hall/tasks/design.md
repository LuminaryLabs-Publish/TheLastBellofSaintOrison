...
Outcome: Cross-check four identities without erasing chosen aliases. Improve layout, visible goal and fair warning signals while preserving reachable exit `flooded-archive`.
