...
Outcome: Cross-check four identities without erasing chosen aliases. Improve observations, arrival, dialogue and choice consequences while preserving reachable exit `flooded-archive`.
