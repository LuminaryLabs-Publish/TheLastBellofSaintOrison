# Return Ascent — assets

Status: production review open
Owner: unassigned. Package: `src/kits/locations/return-ascent`.

Outcome: Use the verified return route and make it back above ground. Improve scene assets, palette, selection and provenance while preserving reachable exit `town-square`.
