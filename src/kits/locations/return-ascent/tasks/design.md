# Return Ascent — design

Status: production review open
Owner: unassigned. Package: `src/kits/locations/return-ascent`.

Outcome: Use the verified return route and make it back above ground. Improve layout, visible goal and fair warning signals while preserving reachable exit `town-square`.
