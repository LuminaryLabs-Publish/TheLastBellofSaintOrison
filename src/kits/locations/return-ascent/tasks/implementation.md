# Return Ascent — implementation

Status: implementation and regression review
Owner: unassigned. Package: `src/kits/locations/return-ascent`.

Outcome: Use the verified return route and make it back above ground. Improve public operations, dependency bindings and outgoing state while preserving reachable exit `town-square`.
