# Return Ascent — validation

Status: implementation and regression review
Owner: unassigned. Package: `src/kits/locations/return-ascent`.

Outcome: Use the verified return route and make it back above ground. Improve legal routes, failed actions, save restoration and disposal while preserving reachable exit `town-square`.
