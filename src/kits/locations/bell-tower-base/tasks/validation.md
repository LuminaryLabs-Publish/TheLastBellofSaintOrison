# Bell Tower Base — validation

Status: implementation and regression review
Owner: unassigned. Package: `src/kits/locations/bell-tower-base`.

Outcome: Learn the bell cycle and choose how to interrupt it. Improve legal routes, failed actions, save restoration and disposal while preserving reachable exit `school-hall`.
