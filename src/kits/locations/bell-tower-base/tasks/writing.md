# Bell Tower Base — writing

Status: production review open
Owner: unassigned. Package: `src/kits/locations/bell-tower-base`.

Outcome: Learn the bell cycle and choose how to interrupt it. Improve observations, arrival, dialogue and choice consequences while preserving reachable exit `school-hall`.
