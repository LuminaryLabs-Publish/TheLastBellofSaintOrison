# Bell Tower Base — assets

Status: production review open
Owner: unassigned. Package: `src/kits/locations/bell-tower-base`.

Outcome: Learn the bell cycle and choose how to interrupt it. Improve scene assets, palette, selection and provenance while preserving reachable exit `school-hall`.
