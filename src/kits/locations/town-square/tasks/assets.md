...
Outcome: Choose how to share the record without claiming what you cannot prove. Improve scene assets, palette, selection and provenance while preserving reachable exit `exit-road`.
