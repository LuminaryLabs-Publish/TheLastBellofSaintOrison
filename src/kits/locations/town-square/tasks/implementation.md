# Town Square — implementation

Status: implementation and regression review
Owner: unassigned. Package: `src/kits/locations/town-square`.

Outcome: Choose how to share the record without claiming what you cannot prove. Improve public operations, dependency bindings and outgoing state while preserving reachable exit `exit-road`.
