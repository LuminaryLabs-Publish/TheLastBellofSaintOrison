...
Outcome: Choose how to share the record without claiming what you cannot prove. Improve layout, visible goal and fair warning signals while preserving reachable exit `exit-road`.
