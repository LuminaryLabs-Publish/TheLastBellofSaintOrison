# Town Square — validation

Status: implementation and regression review
Owner: unassigned. Package: `src/kits/locations/town-square`.

Outcome: Choose how to share the record without claiming what you cannot prove. Improve legal routes, failed actions, save restoration and disposal while preserving reachable exit `exit-road`.
