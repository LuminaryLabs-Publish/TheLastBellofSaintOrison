...
Outcome: Test the resin, then prepare the lantern. Improve observations, arrival, dialogue and choice consequences while preserving reachable exit `bell-tower-base`.
