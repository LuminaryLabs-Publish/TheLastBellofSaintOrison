# Apothecary — validation

Status: implementation and regression review
Owner: unassigned. Package: `src/kits/locations/apothecary`.

Outcome: Test the resin, then prepare the lantern. Improve legal routes, failed actions, save restoration and disposal while preserving reachable exit `bell-tower-base`.
