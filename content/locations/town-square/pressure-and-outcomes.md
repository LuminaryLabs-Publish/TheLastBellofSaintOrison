# Town Square: pressure and outcomes

Base continuous exposure limit: **quiet location; no deadline**. This is the current loop parameter, not a measured location duration.

Warning above 60%: Not applicable: quiet location.

Critical above 85%: Not applicable: quiet location.

Voluntary or forced retreat: You sit on the dry edge of the fountain and let the quiet remain quiet.
...
|---|---|---|---|
| copies | Leave copies with the residents | Flag publicCopies | Exit Road |
| originals | Arrange independent custody of the originals | Flag publicCopies | Exit Road |
