# Well Chamber: asset inventory

## Integrated

- Canonical inline Asset record `well-chamber`, authored in the composition.
- well environment with floor, architecture, lighting and context props generated by Presentation.
- Four stable interactive props: Paired identity records; Intervention instructions; Core release collars; Listen to the unclaimed silence.
