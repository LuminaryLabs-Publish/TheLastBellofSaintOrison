# Well Chamber: pressure and outcomes

Base continuous exposure limit: **180 seconds**. This is the current loop parameter, not a measured location duration.

Warning above 60%: The core begins repeating the first syllable of every recorded name.

Critical above 85%: The outgoing relay pulses. An intervention is still yours to choose.

Voluntary or forced retreat: You close the core’s acoustic shutter. It cannot take an offered name through a closed channel.
...
|---|---|---|---|
| witness | WITNESS · transmit names and original proof | Ending witness | Return Ascent |
| silence | SILENCE · isolate and end the vessel | Ending silence | Return Ascent |
| vessel | VESSEL · knowingly offer your own pattern | Ending vessel | Return Ascent |
