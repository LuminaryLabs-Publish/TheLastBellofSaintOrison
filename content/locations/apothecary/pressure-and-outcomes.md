# Apothecary: pressure and outcomes

Base continuous exposure limit: **155 seconds**. This is the current loop parameter, not a measured location duration.

Warning above 60%: Smoke gathers in the doorway although nothing is burning there.

Critical above 85%: The back-room glass darkens from the inside.

Voluntary or forced retreat: You close the fire screen and return to the ventilated dispensing window.
...
|---|---|---|---|
| street | Carry the treated lantern to the tower | Recorded local choice and departure narration | Bell Tower Base |
| clinical | Take the clinical note as well | Flag clinicalEvidence | Bell Tower Base |
