# Maintenance Tunnels: pressure and outcomes

Base continuous exposure limit: **125 seconds**. This is the current loop parameter, not a measured location duration.

Warning above 60%: The voice behind you takes the sound of your own footsteps.

Critical above 85%: The far light dies. Your chalk marks remain visible.

Voluntary or forced retreat: You return to the pump niche using the pipes you can touch. The voice keeps walking beyond it.
...
|---|---|---|---|
| direct | Continue along the verified pipes | Recorded local choice and departure narration | Well Chamber |
| mark | Chalk the return direction before proceeding | Flag returnMarked | Well Chamber |
