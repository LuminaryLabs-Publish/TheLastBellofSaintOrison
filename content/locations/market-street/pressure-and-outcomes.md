# Market Street: pressure and outcomes

Base continuous exposure limit: **145 seconds**. This is the current loop parameter, not a measured location duration.

Warning above 60%: A shutter slams at the far end of the market.

Critical above 85%: The counterweight begins to slip; the open crossing narrows.

Voluntary or forced retreat: You withdraw to the freight alcove, beyond the shutter’s travel. Its safety stop catches.
...
|---|---|---|---|
| direct | Cross through the freight opening | Recorded local choice and departure narration | Apothecary |
| secure | Secure a return marker before crossing | Flag marketSafe | Apothecary |
