# Parish House: pressure and outcomes

Base continuous exposure limit: **165 seconds**. This is the current loop parameter, not a measured location duration.

Warning above 60%: Footsteps stop outside the study whenever you stop reading.

Critical above 85%: The handle turns once, although the stair is empty.

Voluntary or forced retreat: You move into the utility vestibule and secure its mechanical bolt.
...
|---|---|---|---|
| utility | Descend by the documented utility stair | Recorded local choice and departure narration | Maintenance Tunnels |
| letter | Discuss the letter before descending | Flag elianTrust | Maintenance Tunnels |
