# Bell Tower Base: asset inventory

## Integrated

- Canonical inline Asset record `bell-tower-base`, authored in the composition.
- tower environment with floor, architecture, lighting and context props generated by Presentation.
- Four stable interactive props: Governor service log; Acoustic brace diagram; Governor controls; Relay junction.
