# Bell Tower Base: pressure and outcomes

Base continuous exposure limit: **140 seconds**. This is the current loop parameter, not a measured location duration.

Warning above 60%: The governor’s amber mark approaches the contact plate.

Critical above 85%: The platform shivers. The next ring is almost engaged.

Voluntary or forced retreat: You step off the marked platform and pull its emergency guard closed.
...
|---|---|---|---|
| preserve | Leave the relay intact | Flag relayIntact | School Hall |
| break | Break the shaft · disables Witness transmission | Flag relayBroken | School Hall |
