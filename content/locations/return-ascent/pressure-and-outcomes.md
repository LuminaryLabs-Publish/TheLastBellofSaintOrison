# Return Ascent: pressure and outcomes

Base continuous exposure limit: **115 seconds**. This is the current loop parameter, not a measured location duration.

Warning above 60%: Water strikes the pump housing from the wrong side.

Critical above 85%: The upper service gate begins to settle into its frame.

Voluntary or forced retreat: You shelter in the pump niche. Its mechanical hand release still works after the bell’s intervention.
...
|---|---|---|---|
| leave | Continue to the square | Recorded local choice and departure narration | Town Square |
| help | Hold the line until Elian confirms her route | Flag elianHelped | Town Square |
