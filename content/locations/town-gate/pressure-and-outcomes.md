# Town Gate: pressure and outcomes

Base continuous exposure limit: **150 seconds**. This is the current loop parameter, not a measured location duration.

Warning above 60%: The indicator turns amber. A second bell is gathering in the iron.

Critical above 85%: A figure stands inside the fog. The shelter is still open.

Voluntary or forced retreat: You step behind the stone recess. Something crosses where you were standing. It never enters the marked shelter.
...
|---|---|---|---|
| shelter | Wait in shelter; cross on the dark lamp | Recorded local choice and departure narration | Visitor Centre |
| passage | Take the marked maintenance passage | Flag gateMarks | Visitor Centre |
