# Flooded Archive: asset inventory

## Integrated

- Canonical inline Asset record `flooded-archive`, authored in the composition.
- archive environment with floor, architecture, lighting and context props generated by Presentation.
- Four stable interactive props: Archive index; Pump instructions; Indexed records cabinet; Waterproof carbon case.
